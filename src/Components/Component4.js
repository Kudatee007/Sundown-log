    ...
    return (
        <div>
            <div className='div4'>
                ...
                <p className='p22'>
                    We have professional and personalized transportation services to make your journey more than a destination. We also provide rides that are super safe, luxurious and prompt.
                </p>
            </div>
            <div className='flex_div'>
                <div className='flex'>
                    <img className='img2' src={secured} alt="" />
                    <p className='p4'>Our vehicles are maant to be the highest standard of safety.  </p>
                </div>
                <div className='flex'>
